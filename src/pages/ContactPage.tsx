      ...
      <Flex padding={"0 10%"} flexDir={"column"} gap="2rem" mt="2rem">
        ...
        <Flex flexDir={"column"} gap="0.5rem">
          <Text fontFamily={"Montserrat"} color={"#116CA0"}>
            A RESPIRAR PRODUTOS BIOMÉDICOS Ltda. é uma empresa jovem no Brasil,
            mas foi criada com a suma de experiencia de mais de 20 anos no
            mercado de atenção domiciliar prestando o serviço de aluguel e venda
            de equipamento médicos para internação domiciliar.
          </Text>
          <Text fontFamily={"Montserrat"} color={"#116CA0"}>
            Nossos especialistas são formados para dar o melhor serviço e
            assessoramento na hora de atenção domiciliar, tendo os cuidados que
            você merece e o correto mantenimento de cada um de os aparelhos para
            cuidar sua saúde.
          </Text>
          <Text fontFamily={"Montserrat"} color={"#116CA0"}>
            Dispomos de uma grande variedade de equipamentos, produtos, além de
            acessórios como circuitos, máscaras e informações digitalizadas para
            um acompanhamento mais próximo, tanto para o tratamento da DPOC,
            para apneia do sono e doenças neuromusculares que afetam a função
            respiratória. fazer o tratamento em sua própria casa com seus entes
            queridos é uma recuperação pronta. 
          </Text>
          <Text fontFamily={"Montserrat"} color={"#116CA0"}>
            Contamos também com uma completa línea de equipamentos para
            professionais da saúde e hospitalar. Temos sistemas de respiração
            autônomos portátil, equipamento para poligrafias e polissonografia,
            exercitador pulmonar, e muitos mais.
          </Text>
          <Text fontFamily={"Montserrat"} color={"#116CA0"}>
