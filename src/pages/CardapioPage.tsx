    ...
    <Flex flexDir="column" w="100%">
      ...
      >
        <Flex width={"100%"} padding={"3% 0"} flexDirection={"column"} gap={"3rem"}>
          <Heading fontSize={{base: "36px", md:"48px", lg:"72px"}}>Respire bem!</Heading>
          <Container margin={"0"} padding={"0"} color={"#116CA0"}>
            <Box as="h2" fontSize="36px">Viva bem!</Box>
            <Text fontSize="20px">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Error reiciendis temporibus ut sequi ipsam asperiores eos aut, facere eligendi odio numquam odit eius tempora ea veritatis recusandae quasi porro quam!
            </Text>
          </Container>
          <Button w={"240px"} h={"60px"} background={"#116CA0"} color={"#E9F1F5"}>Saiba Mais</Button>
        </Flex>
